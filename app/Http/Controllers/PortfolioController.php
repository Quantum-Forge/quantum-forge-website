        ...
        $portfolios = Portfolio::query()
            ...
            ->map(function ($p) {
                return [
                    ...
                    'link' => $p->link,
                    'slug' => $p->slug,
                    'images1' => $p->images1 ? asset('storage/' . $p->images1) : null,
                    'images2' => $p->images2 ? asset('storage/' . $p->images2) : null,
                    'images3' => $p->images3 ? asset('storage/' . $p->images3) : null,
                    'images4' => $p->images4 ? asset('storage/' . $p->images4) : null,
