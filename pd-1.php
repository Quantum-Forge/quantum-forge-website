				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="work-left work-details">
						<div class="portfolio-main-info">
							<h2 class="title">Buahatiku-MIS</h2>
							<!-- Start Details List -->
							<div class="work-details-list mt-60">
								...
								<div class="details-list">
									...
									<span><a href="#">Web App, Desktop App, DBMS, MIS</a></span>
								</div>
							...
							<div class="work-content">
								...
								<div class="desc mt-40">
									<div class="content mb-25">
										<p>
										Buah Hatiku adalah sebuah aplikasi berbasis web yang dirancang khusus untuk digunakan oleh admin dan terapis yang memiliki hak akses khusus. 
										Aplikasi ini memungkinkan admin untuk mengelola data anak terapi, mengatur jadwal terapi, dan mengakses informasi penting terkait dengan terapi autisme. 
										Terapis yang merupakan pemilik dari pusat terapi juga dapat menggunakan aplikasi ini untuk mencatat perkembangan pasien, merencanakan sesi terapi, dan berkomunikasi dengan admin serta orang tua pasien. 
										Dengan fokus pada keamanan dan keberlangsungan layanan terapi, 
										aplikasi ini memberikan solusi yang efisien dan terpercaya bagi penyedia layanan terapi autisme.
										</p>
									</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="custom-column-thumbnail mt-lg-70">
						<img class="w-100" src="images/project/bh-01.png" alt="finance">
					</div>
				</div>
			</div>
			...
			<div class="row mt-lg-100">
				<div class="col-lg-4 col-md-12 col-12">
					<div class="digital-marketing">
						<h3 class="heading heading-h3">Yayasan Terapi Autistik Buahatiku.</h3>
					</div>
				</div>
				<div class="col-lg-7 col-md-12 col-12 offset-lg-1">
					<div class="digital-marketing mt-30">
						<div class="inner">
							<p>Yayasan Terapi Autistik Buahatiku didirikan untuk memberikan dukungan dan layanan terapi bagi anak-anak dengan autisme di Makassar. 
								Buahatiku menyediakan berbagai program terapi individual yang dirancang khusus untuk kebutuhan unik setiap anak. 
								Layanan Buahatiku meliputi terapi wicara, okupasi, dan perilaku, yang dilakukan oleh tim profesional terlatih. 
								Buahatiku juga menyediakan dukungan bagi keluarga, memberikan edukasi dan sumber daya agar mereka dapat mendukung perkembangan anak-anak mereka dengan lebih baik. 
								Misi Buahatiku adalah membantu setiap anak autistik mencapai potensi penuh mereka dalam lingkungan yang mendukung dan inklusif.</p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="custom-layout-gallery mt-lg-100">
				<div class="row mb-n30">
					<div class="col-lg-6 col-md-6 col-12">
						<div class="thumbnail">
							<img class="w-100" src="images/project/bh-02.png" alt="finance">
						</div>
					</div>
					<div class="col-lg-6 col-md-6 col-12 mt-50">
						<div class="thumbnail">
							<img class="w-100" src="images/project/bh-03.png" alt="finance">
						</div>
					</div>

					<div class="col-lg-12 mtb-30">
						<div class="thumbnail">
							<img class="w-100" src="images/project/bh-04.png" alt="finance">
						</div>
					</div>
				</div>
			</div>
